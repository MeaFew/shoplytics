...
-- 硬编码 '2017-12-03' 出现位置索引（共3处）：
--   第 21 行: DATE_DIFF('day', MAX(date), '2017-12-03')  -- 第一部分
--   第 92 行: DATE_DIFF('day', MAX(date), '2017-12-03')  -- 第三部分
--   第146行: DATE_DIFF('day', MAX(date), '2017-12-03')  -- 第四部分
-- ============================================================
