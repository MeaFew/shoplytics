...
-- ============================================================
-- NOTE: 本脚本使用 user_id % 2 奇偶分组作为 SQL 演示环境的简化分组。
-- 生产级方案请参考 scripts/pipeline.py（第326-329行）中的
-- hashlib.md5 哈希随机化 + SRM (Sample Ratio Mismatch) 检查，
-- 哈希分组更稳健（避免 user_id 顺序偏差），建议生产环境使用。
-- ============================================================
