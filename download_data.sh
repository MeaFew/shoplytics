#!/usr/bin/env bash
# Download real dataset for shoplytics
# Source: Alibaba Tianchi — Taobao User Behavior (29M records)
# Size: ~1.1GB compressed → ~1.1GB CSV

set -euo pipefail

RELEASE_URL="https://github.com/MeaFew/shoplytics/releases/download/v1.0-data/data.zip"
DEST_DIR="$(dirname "$0")"

echo "Downloading data for shoplytics..."
